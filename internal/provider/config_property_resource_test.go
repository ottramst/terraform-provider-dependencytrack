...
// TestAccConfigPropertyResource tests the config_property resource.
...
// TestAccConfigPropertyResource_EncryptedString tests the config_property resource with an encrypted string property.
...
func TestAccConfigPropertyResource_EncryptedString(t *testing.T) {
	resource.Test(t, resource.TestCase{
